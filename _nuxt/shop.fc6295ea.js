...
`,body:!0}]});const s=n(!0);return p(()=>{const o=document.querySelector("#my-store-82685269"),i={attributes:!0};function c(d,I){d.forEach(function(r){r.type==="attributes"&&r.attributeName==="class"&&(s.value=!1)})}new MutationObserver(c).observe(o,i)}),(o,i)=>(m(),_("main",null,[t("div",g,[u(t("div",null,x,512),[[w,l(s)]])])]))}},V=h(B,[["__scopeId","data-v-3d46d658"]]);export{V as default};
